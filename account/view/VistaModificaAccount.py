...
class VistaModificaAccount(QWidget):
    def __init__(self, account, modifica_nome, modifica_cognome, modifica_username, modifica_password,
        ...
        self.modifica_username = modifica_username
        ...
        h_layout3.addWidget(label_username)

        text_username = QLineEdit()
        text_username.setText(self.controller.get_username_account())
        h_layout3.addWidget(text_username)
        ...
        h_layout4.addWidget(label_password)

        text_password = QLineEdit()
        text_password.setEchoMode("Password")
        text_password.setText(self.controller.get_password_account())
        h_layout4.addWidget(text_password)
        ...
        update_btn.clicked.connect(
            self.modifica(text_nome, text_cognome, text_username, text_password, text_codice_fiscale))
    ...
    def modifica(self, text_nome, text_cognome, text_username, text_password, text_codice_fiscale):
        ...
        if text_username.isModified():
            self.modifica_username(text_username.text())
